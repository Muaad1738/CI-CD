...
```
 - use the commands to insatll java and jenkins.
 - use the link of your public IP with the port 8080 to access jenkins.
 - install all the plugins needed.
 - create the jobs to to link git hub, merge dev to main and launch the app.
 - 